...
namespace TorchPlugin
{
    public class Commands : CommandModule
    {
        ...
        {
            Respond("InteractWithOutside commands:");
            Respond("  !cmd help");
            Respond("  !cmd info");
        ...
        [Command("cmd help", "InteractWithOutside: Help")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd info", "InteractWithOutside: Prints the current settings")]
        [Permission(MyPromoteLevel.None)]
        public void Info()
        {
            RespondWithInfo();
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd enable", "InteractWithOutside: Enables the plugin")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd disable", "InteractWithOutside: Disables the plugin")]
        [Permission(MyPromoteLevel.Admin)]
        public void Disable()
        {
        ...
        // TODO: Subcommand
        // ReSharper disable once UnusedMember.Global
        [Command("cmd subcmd", "InteractWithOutside: TODO: Subcommand")]
        [Permission(MyPromoteLevel.Admin)]
